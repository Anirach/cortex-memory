...
\begin{enumerate}[leftmargin=*]
    ...
    \item \textbf{Automatic prompt engineering} via a PromptAssembler that analyzes task complexity (simple, moderate, complex, knowledge gap, skill execution) and selects optimal combinations from ten prompt techniques including chain-of-thought, ReAct, few-shot, and self-critique, with outcome recording for self-improvement.
